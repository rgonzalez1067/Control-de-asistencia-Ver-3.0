...
import ReporteGeneralAccesosPage from "@/pages/ReporteGeneralAccesosPage";
      ...
      <AuthProvider>
        ...
        <Routes>
          ...
          >
            ...
            <Route path="reportes/general-accesos" element={
              <ProtectedRoute permKey="reporte_general_accesos">
                <ReporteGeneralAccesosPage />
              </ProtectedRoute>
            } />
